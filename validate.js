    ...
    $("form").each(function () {
        $(this).validate({
            rules: {
                ...
                phone: {required: true, minlength: 18, num2: true,}
            },
            messages: {name: "Имя должно быть больше 3 букв", phone: "Введите все цифры в номере"},
            submitHandler: function () {
                ...
                function type() {
                    if (dots <= 3) {
                        if (dots == 1) {
                            $('*[type=submit]').val('Идет отправка.');
                            $('button .text').text('Идет отправка.');
